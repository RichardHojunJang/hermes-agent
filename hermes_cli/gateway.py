...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            ...
            "4. Use long polling (getUpdates) here — if you previously set a Webhook, call deleteWebhook first",
            "5. Add ZALO_ALLOWED_USERS with your Zalo user id for production (comma-separated)",
