...
OPTIONAL_ENV_VARS = {
    ...
    "ZALO_BOT_TOKEN": {
        "description": "Zalo Bot Platform bot token from Zalo Bot Creator (not Zalo OA)",
        "prompt": "Zalo Bot token",
        "url": "https://bot.zapps.me/docs/create-bot/",
        "password": True,
        "category": "messaging",
    },
    "ZALO_ALLOWED_USERS": {
        "description": "Comma-separated Zalo user IDs allowed to use the bot",
        "prompt": "Allowed Zalo user IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "ZALO_ALLOW_ALL_USERS": {
        "description": "Allow all Zalo users to use the bot (true/false). Default: false.",
        "prompt": "Allow all Zalo users (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "ZALO_HOME_CHANNEL": {
        "description": "Default Zalo chat id for cron/send_message when no explicit target is set",
        "prompt": "Zalo home chat id",
        "url": None,
        "password": False,
        "category": "messaging",
    },
