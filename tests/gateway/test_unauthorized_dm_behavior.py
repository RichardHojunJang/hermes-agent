...
def _clear_auth_env(monkeypatch) -> None:
    for key in (
        ...
        "DINGTALK_ALLOWED_USERS", "FEISHU_ALLOWED_USERS", "WECOM_ALLOWED_USERS", "ZALO_ALLOWED_USERS",
        ...
        "DINGTALK_ALLOW_ALL_USERS", "FEISHU_ALLOW_ALL_USERS", "WECOM_ALLOW_ALL_USERS", "ZALO_ALLOW_ALL_USERS",
